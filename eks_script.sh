...
# Create EKS cluster
eksctl create cluster kubedemo21 --vpc-public-subnets=subnet-0c7755f1dba6358c8,subnet-0c893fcb7da57f2d1 --vpc-private-subnets=subnet-096cb6de98d7239f0,subnet-088b523a067045ade --without-nodegroup
...
eksctl utils associate-iam-oidc-provider --region=us-east-1 --cluster=demo32 --approve
...
eksctl create iamserviceaccount \
  ...
  --attach-policy-arn=arn:aws:iam::008971635785:policy/AWSLoadBalancerControllerIAMPolicy \
  --approve
...
aws elbv2 describe-load-balancers --query 'LoadBalancers[*].[LoadBalancerName,DNSName]' --output text >> loadbalancerdns7.txt
